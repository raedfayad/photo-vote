    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-xs">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <h1 className="text-lg font-bold text-center mb-6">Admin Login</h1>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 active:bg-gray-100 text-gray-700 font-medium py-3 rounded-xl transition-colors disabled:opacity-50 shadow-sm"
          >
            {loading ? (
